...
| <a name="input_responsible_egroup_name"></a> [responsible\_egroup\_name](#input\_responsible\_egroup\_name) | E-group name for the sets responsible (Uppercase) | `string` | `"TERRAFORM-PROVIDER-LANDB"` | no |
| <a name="input_responsible_type"></a> [responsible\_type](#input\_responsible\_type) | Contact type for the set (e.g. EGROUP) | `string` | `"EGROUP"` | no |
...
| <a name="input_set_name"></a> [set\_name](#input\_set\_name) | The name of the shared LanDB set | `string` | `"terraform-openstack-puppet-set"` | no |
